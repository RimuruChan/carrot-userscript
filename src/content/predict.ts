...
export class PredictResult {
  ...
  constructor(handle: string, rating: number | null, delta: number | null, performance: number | null) {
    this.handle = handle;
    this.rating = rating;
    this.delta = delta;
...
export class RatingCalculator {
  ...
  calcDelta(contestant: Contestant, assumedRating: number) {
    const c = contestant;
  ...
  rankToRating(rank: number, selfRating: number) {
...
export default function predict(contestants: Contestant[], calcPerfs = false) {
